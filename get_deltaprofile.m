...
s_nan = min(2,find(isnan(shelf_x),1)-1); 
if isempty(s_nan), s_nan=2; elseif s_nan<2, s_nan=2; shelf_x = (0:20:400)./1e-3; end
shelf_h = -(0:20:400);
...
shelf_x = shelf_x(1:s_nan);
shelf_h = shelf_h(1:s_nan);
